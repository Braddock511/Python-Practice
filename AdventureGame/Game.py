    ...
    while True:
        ...
        #     rich_villager.window(f"Hello stranger!\nRecently in our village has been strange things.\nIn my house start disappeared treasures.\nI'm pissed off!\nI think that blacksmith steal my things!\nFirst go to him and talk with him.\nIf you catch that the bastard, I will pay you 25 gold.\nWhat do you think? You can do it for me?", False)
            ...
            if take.upper()=='Y':
                ...
                # gold = dbase.execute(f"SELECT gold FROM main, characters as ch, weapons as w, users as u WHERE id_user = (SELECT id FROM users WHERE name='{dbase.get_name()}')  AND u.name='{dbase.get_name()}' AND main.id_character = ch.id AND id_weapon = w.id ")
                items = Items(0)
                ...
                while end_village:
                        ...
                        while True:
                            ...
                            if doors==2:
                                if basement_flag==False:
                                    ...
                                    print("")
                                    time.sleep(1.5)
                                    result_of_fight = Combat(character_statistics, weapon_statistics, *get_enemy('Rat')).fight()
                    ...
                    if house==2:
                        while True:
                            ...
                            #main room
                            if doors==2:
                                if blacksmith==False or blacksmith_fight_flag==False: 
                                    ...
                                    if kill_blacksmith == 2 or kill_blacksmith2 == 2:
                                        ...
                                        result_of_fight = Combat(character_statistics, weapon_statistics, *get_enemy('Blacksmith')).fight()
